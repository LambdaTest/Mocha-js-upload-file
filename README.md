# Upload Files in Mocha Tests on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can upload Files in Mocha Tests across real browsers and operating systems.
